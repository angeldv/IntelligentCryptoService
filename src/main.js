// src/main.js
/**
 * Main entry point for IntelligentCryptoService application
 */
...
class IntelligentCryptoService {
    /**
     * Create a new IntelligentCryptoService instance
...
module.exports = IntelligentCryptoService;
...
if (require.main === module) {
    ...
    const app = new IntelligentCryptoService({
        input: args.input,
        output: args.output,
