// test/test_intelligentCryptoService.js
/**
 * Unit tests for IntelligentCryptoService
 */

const assert = require('assert');
const { IntelligentCryptoService } = require('../src/main');
const fs = require('fs').promises;
const path = require('path');

describe('IntelligentCryptoService', function() {
    this.timeout(5000);
